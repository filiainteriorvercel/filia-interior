                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition duration-300">
                        <div class="text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">Kelola Portfolio</h3>
                            <p class="text-gray-600 mb-4">{{ $totalPortfolios }} Project Tersimpan</p>
                            <a href="{{ route('dashboard.portfolios.index') }}" class="inline-block bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition duration-300">
                                Kelola Portfolio
                            </a>
                        </div>
                    </div>
